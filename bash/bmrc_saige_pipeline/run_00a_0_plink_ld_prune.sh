...
readonly samples_w_superpop="/data/00_set_up/ukb_wes_450k.qced.sample_list_w_superpops.tsv"

## [OUTPUT]
readonly out="data/00_set_up/ukb_array.wes_450k_qc_pass_${pop}.pruned.chr${chrom}"
